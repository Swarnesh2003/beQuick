  ...
  return (
    ...
    >
      ...
      >
        ...
        <Typography sx={{marginLeft:2, fontSize:'115%'}}>New Bid</Typography>
      </div>}
          component={Link}
          to="/bidder/dashboard1/newbid" // Specify the target route
        />
      ...
      <Tab sx={{textTransform: 'none'}} label={
        <div style={{display:'flex', alignItems: 'center',  position:'absolute',left:'1.5vw'}}>
            ...
            <Typography sx={{marginLeft:2, fontSize:'115%'}}>Ongoing Bid</Typography>
        </div>
      }
      component={Link}
      to="/bidder/dashboard1/ongoingbid"  />
      <Tab sx={{textTransform: 'none'}} label={
        <div style={{display:'flex', alignItems: 'center', position:'absolute',left:'1.5vw'}}>
          
            < DownloadDoneRoundedIcon /> {/* Replace with your desired icon */}
          
            <Typography sx={{marginLeft:2, fontSize:'115%'}}>Winnings</Typography>
        </div>
      }       component={Link}
      to="/bidder/dashboard1/winnings"  />
      ...
      to="/bidder/dashboard1/transaction1"  />
      </Tabs>
